...
<div class="container">
  <div class="profile">
    ...
    <h2>HELLO, I'M Trần Vĩnh Mạnh Hưng</h2>
    <div class="social-icons">
      <a href="https://www.facebook.com/manhhung.tranvinh" target="_blank"><i class="fab fa-facebook"></i></a>
      <a href="https://www.instagram.com/manhhungw11/" target="_blank"><i class="fab fa-instagram"></i></a>
      <a href="https://github.com/tranvinhmanhhung" target="_blank"><i class="fa-brands fa-github"></i></a>
    </div>
  </div>
  <div class="content">
    <h2>About Me</h2>
    ...
    <a href="mailto:hung.tvm.64cntt@ntu.edu.vn" class="button">CONTACT ME</a>
  </div>
</div>
</body>
</html>
